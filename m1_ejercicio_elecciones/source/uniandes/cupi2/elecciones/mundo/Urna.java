...
public class Urna
{
  ...
  //TODO Declare el atributo de candidato3
    ...
    {          
    	double votoCandidato1;
    	double totalVotos; 
    	double porcentaje;
    	
    	votoCandidato1 = candidato1.darVotosInfluenciaInternet();
    	totalVotos = calcularTotalVotos();
    	if(votoCandidato1 > 0) {
    		porcentaje = votoCandidato1 / totalVotos;
    	}
    	else {
    		porcentaje = 0;
    	}   	
    ...
    public double calcularPorcentajeVotosCandidato2( )
    {
    	...
    	double votoCandidato2;
    	double totalVotos; 
    	double porcentaje;
    	
    	votoCandidato2 = candidato2.darVotos();
    	totalVotos = calcularTotalVotos();
    	
    	if(votoCandidato2 > 0) {
    		porcentaje = votoCandidato2 / totalVotos;
    	}
    	else {
    		porcentaje = 0;
    	}   	
    ...
    {
    	double votoCandidato3;
    	double totalVotos; 
    	double porcentaje;
    	
    	votoCandidato3 = candidato1.darVotos();
    	totalVotos = calcularTotalVotos();
    	porcentaje = votoCandidato3 / totalVotos;
    	if(votoCandidato3 > 0) {
    		porcentaje = votoCandidato3 / totalVotos;
    	}
    	else {
    ...
    public double calcularPorcentajeVotosPorInternetCandidato1( )
    {
    	...
    	double porcentaje;
        double votosTotales = calcularTotalVotosInternet();
        numVotosCandidato1 = candidato1.darVotosInfluenciaInternet();
         
        if(numVotosCandidato1 == 0) {
        	return 0;
        }
        else {
        	return porcentaje = (numVotosCandidato1 * 100 / votosTotales);
        }     
    ...
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
    	double numVotosCandidato2 = candidato2.darVotosInfluenciaInternet();
        double votosTotales = calcularTotalVotosInternet();

        double porcentaje = (numVotosCandidato2 / votosTotales) * 100;
        if(numVotosCandidato2 != 0) {
        	return porcentaje;
        }
        else {
        	return 0;
    ...
    public double calcularPorcentajeVotosPorInternetCandidato3( )
    {
    	...
    	double numVotosCandidato3 = candidato3.darVotosInfluenciaInternet();
        double votosTotales = calcularTotalVotosInternet();

        double porcentaje = (numVotosCandidato3 / votosTotales) * 100;
        if(numVotosCandidato3 != 0) {
        	return porcentaje;
        }
        else {
        	return 0;
