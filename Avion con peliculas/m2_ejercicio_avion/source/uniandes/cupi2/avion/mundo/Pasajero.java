...
public class Pasajero
{
    ...
    public int darDuracionTotalPeliculas()
    {
    	...
    	for (int i = 0; i < peliculas.size(); i++) {
    		...
    		total = total + actual.darDuracion(); 
    ...
    {
    	ArrayList <Pelicula> actual = new ArrayList<Pelicula>(); 
    ...
    public boolean tienePeliculasMismaDuracion()
    {
    	...
    	for (int i = 0; i <peliculas.size(); i++) {
    		...
    		for (int j = i + 1; j <peliculas.size(); j++) {
    			...
    			Pelicula comparacion = peliculas.get(j); 
    			
    			if (actual.darDuracion() == comparacion.darDuracion()) {
